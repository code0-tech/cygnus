...
export const ContactSection: React.FC = () => {
    ...
    return (
        <div className={"relative overflow-hidden w-full flex flex-col items-center justify-center gap-8 py-12 rounded-xl ring ring-white/5 shadow-xl"}>
            ...
            <div
                className="
                    pointer-events-none
                    absolute inset-0 mt-8
                    opacity-35 blur-2xl
                    will-change-filter
                    [background:radial-gradient(circle_at_top,rgba(112,255,179,0.45),transparent_65%)]
                "
            />
