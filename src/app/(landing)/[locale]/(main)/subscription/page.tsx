...
export default async function SubscriptionPage({ params }: { params: LocalePageParams }) {
    ...
    const [page, subscriptionConfig, subscriptionPrices] = await Promise.all([getLandingPage("subscription", locale), getSubscriptionConfig(locale), getCraterSubscriptionPrices()])
