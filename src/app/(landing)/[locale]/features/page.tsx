...
export const generateMetadata = createLandingMetadata("features")

export default async function FeaturesPage({ params }: { params: LocalePageParams }) {
    const locale = await getPageLocale(params)
    const page = await getLandingPage("features", locale)
    if (!page) notFound()
