...
export default async function LicenseUpgradePage({ params }: { params: Promise<{ customerId: string; licenseId: string; locale: string }> }) {
    ...
    return <LicenseUpgradeDialog content={content} customerId={customerId} errors={errors} licenseId={licenseId} locale={locale} subscriptionConfig={subscriptionConfig} />
}
