...
const consentTheme = {
    slots: {
        ...
        consentBannerCard: "bg-secondary! border-white/10! shadow-xl!",
        consentBannerFooter: "bg-secondary! border-white/10!",
        consentDialogTitle: "text-white!",
        consentDialogDescription: "text-white/75! [&_a]:text-brand!",
        consentDialogCard: "bg-secondary! border-white/10! shadow-xl!",
