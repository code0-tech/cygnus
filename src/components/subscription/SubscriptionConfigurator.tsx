...
function SubscriptionOptionCategoryLabel({ label }: { label: string }) {
    return (
        <p className={cn("text-xl", hasHighlightedText(label) ? "text-secondary" : "text-white")}>
            ...
            <div className="relative z-10 flex flex-col gap-8">
                    ...
                    {selection.plan === "custom" && (
                        <div className="space-y-2">
                            ...
                            <Slider
                                ...
                                className="mt-4 rounded-2xl border border-white/10 p-3"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="mt-2 flex w-full items-center justify-between gap-4">
                                ...
                                <div className="flex flex-wrap items-start justify-end gap-2">
                                    ...
                                    <LinkButton href={content.contactSales.href} className="py-0 text-sm border-b-0 text-secondary" showArrow={false}>
                ...
                <div className="">
                    <div className="mb-3 flex min-w-0 items-baseline justify-end gap-2 text-right">
                        ...
                        />
                        <span className="max-w-28 truncate text-xs text-tertiary">{monthlyPeriodSuffix}</span>
                    </div>
