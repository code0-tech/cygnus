...
export function FirstBlogCard({ locale, post }: { locale: string, post: BlogPostItem }) {
    ...
    return (
        ...
        >
            <Card
                variant="filled"
                className="relative overflow-hidden rounded-3xl! border! border-white/8! bg-[linear-gradient(160deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02)_28%,rgba(8,10,20,0.92)_100%)]! shadow-[0_18px_60px_rgba(0,0,0,0.35)]! transition-all! duration-500! hover:-translate-y-1! hover:shadow-[0_26px_80px_rgba(0,0,0,0.42)]! p-3!"
            >
