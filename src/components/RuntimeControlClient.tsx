...
export function RuntimeControlClient() {
    ...
    return (
        <>
            ...
            <div className={cn("pointer-events-none absolute left-[42%] top-[43%] h-32 w-[54%] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[90px] transition-colors duration-500", runtimeStyles[runtimeType])}/>
            <div className={cn("pointer-events-none absolute left-[58%] top-[57%] h-32 w-[54%] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[90px] transition-colors duration-500", executionStyles[executionType])}/>
