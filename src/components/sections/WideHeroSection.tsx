        ...
        <Section showFunnel={false} animation={{ preset: "none" }} className="-mt-16 w-dvw max-w-none self-center lg:-mt-20 overflow-hidden border-b border-white/15">
            <div className="relative isolate min-h-[calc(100svh-3rem)] w-full bg-primary lg:h-[calc(100dvh-8rem)] lg:min-h-0">
                <div className="relative z-20 mx-auto grid min-h-[calc(100svh-3rem)] w-full max-w-348 grid-cols-1 grid-rows-[auto_auto] overflow-hidden lg:h-full lg:min-h-0 lg:grid-cols-[0.85fr_1.15fr] lg:grid-rows-1">
                    <StaggerContainer className="flex min-w-0 flex-col items-center justify-center px-6 pb-10 pt-28 text-center sm:px-8 sm:pb-12 sm:pt-32 md:px-12 lg:items-start lg:p-12 lg:text-left xl:p-16">
                        {content.badge && (
                            <StaggerItem>
                                {content.badge_link ? (
                        ...
                        <StaggerItem as="h1" className="mt-4 max-w-2xl text-balance text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
                            {content.heading}
                        </StaggerItem>

                        {texts.length > 0 && (
                            <StaggerItem as="p" className="mt-4 max-w-xl text-pretty text-base font-medium leading-7 text-white sm:text-lg lg:text-xl">
                        ...
                        {buttons.length > 0 && (
                            <StaggerItem className="mt-8 flex w-full flex-col justify-center gap-2 sm:gap-4 lg:justify-start">
