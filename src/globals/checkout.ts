    ...
    fields: [
        ...
        },
        {
            ...
            fields: [
                ...
                { name: "countryLabel", type: "text", required: true, localized: true, defaultValue: "Country code" },
                { name: "countryPlaceholder", type: "text", required: true, localized: true, defaultValue: "DE" },
