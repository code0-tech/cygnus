...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_blocks_stats_section_layout" AS ENUM('center', 'left');
  CREATE TABLE "pages_blocks_stats_items" (
  	...
  	"enable_number_flow" boolean DEFAULT true
  );
  ...
  CREATE TABLE "pages_blocks_stats" (
  	...
  	"section_layout" "enum_pages_blocks_stats_section_layout" DEFAULT 'center' NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_stats_section_layout";`)
}
