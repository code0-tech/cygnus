...
export const Blog: CollectionConfig = {
        ...
        beforeChange: [
            async ({ data, operation, originalDoc, req }) => {
                ...
                const pinnedPosts = await req.payload.find({
                    ...
                    where: currentDocId
                        ? {
                              and: [{ isPinned: { equals: true } }, { id: { not_equals: currentDocId } }],
                          }
    ...
    fields: [
        ...
        },
        {
            ...
            localized: true,
            hooks: {
                afterRead: [({ value }) => sanitizeLexicalUploadValues(value)],
                beforeChange: [({ value }) => sanitizeLexicalUploadValues(value)],
            },
        },
        {
