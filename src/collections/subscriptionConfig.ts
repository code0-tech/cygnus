  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        { name: "title", type: "text", required: true, localized: true },
        { name: "description", type: "textarea", required: true, localized: true },
        { name: "min", type: "number", required: true, defaultValue: 2 },
        { name: "max", type: "number", required: true, defaultValue: 250 },
    ...
    },
    {
      ...
      fields: [
        { name: "title", type: "text", required: true, localized: true },
        { name: "description", type: "textarea", required: true, localized: true },
        { name: "monthlyLabel", type: "text", required: true, localized: true },
        { name: "paygLabel", type: "text", required: true, localized: true },
        { name: "paygDescription", type: "textarea", required: true, localized: true },
