...
import { createCheckoutQuery, createMainAppLoginUrl } from "../../src/lib/checkout/checkoutLogin"
...
test("appends the absolute checkout URL to the configured login URL", () => {
    ...
    assert.equal(result, "https://app.example/login?source=pricing&redirectUrl=https%3A%2F%2Fcode0.example%2Fde%2Fcheckout%3Fplan%3Dcustom")
})
